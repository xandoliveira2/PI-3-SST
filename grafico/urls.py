...
from .views import density_map_view,enviar_coluna_data,recebe_data,enviar_coluna_horarios,login_view#,update_map

app_name = 'grafico'  # Define o namespace do app


urlpatterns = [
    path('density-map/', density_map_view, name='update_map'),
